...
import 'package:video_game_messaging_app/common/app_background.dart';
import 'package:video_game_messaging_app/common/label_value_widget.dart';
import 'package:video_game_messaging_app/model/forum.dart';
import 'package:video_game_messaging_app/model/topic.dart';
...
class _DetailsPageState extends State<DetailsPage> with SingleTickerProviderStateMixin {
  ...
  Animation<double> _fadeAnimate;
  Animation<double> _scaleAnimate;
  Animation<Offset> _offsetAnimate;

  @override
  void initState() {
    super.initState();
    _controller = AnimationController(vsync: this, duration: Duration(milliseconds: 800));
    _fadeAnimate = Tween<double>(begin: 0.0, end: 1.0).animate(_controller);
    _scaleAnimate = Tween<double>(begin: 0.0, end: 1.0).animate(_controller);
    _offsetAnimate = Tween<Offset>(begin: Offset(0, 1), end: Offset(0, 0)).animate(_controller);
  }
